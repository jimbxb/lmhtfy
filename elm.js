	...
	*/
	...
	var $author$project$Main$init = F2(
		function (url, key) {
			var model = {
				key: key,
				page: $author$project$Main$QueryPage(
					A3(
				...
				if (_v0.a.$ === 'Nothing') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$TutorialPage(
	...
	var $author$project$Pages$Query$Nop = { $: 'Nop' };
		...
		function (msg, model) {
			switch (msg.$) {
				...
				case 'GenerateLink':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								link: $elm$core$Maybe$Just(model.query)
							}),
						$author$project$Pages$Query$Nop);
				case 'CopyLink':
					var id = msg.a;
				...
				default:
					return _Utils_Tuple2(
						model,
						$author$project$Pages$Query$Goto(model.query));
			}
		});
	var $author$project$Pages$Tutorial$ExternalGoto = function (a) {
		return { $: 'ExternalGoto', a: a };
	};
				...
				default:
					return _Utils_Tuple2(
						...
						$author$project$Pages$Tutorial$ExternalGoto(
							$author$project$Pages$Tutorial$hoogleQuery(model.query)));
			}
		});
		...
		function (msg, model) {
			...
			while (true) {
				switch (_v0.a.$) {
					case 'UrlChanged':
						var url = _v0.a.a;
						return A2($author$project$Main$init, url, model.key);
					case 'UrlRequest':
						var req = _v0.a.a;
						if (req.$ === 'Internal') {
							var url = req.a;
						...
						if (_v0.b.$ === 'QueryPage') {
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										page: $author$project$Main$QueryPage(newQmodel)
									}),
								cmd);
						} else {
							break _v0$4;
						...
						if (_v0.b.$ === 'TutorialPage') {
							...
							var cmd = function () {
								switch (cmdMsg.$) {
									case 'Goto':
										var url = cmdMsg.a;
										return A2($elm$browser$Browser$Navigation$pushUrl, model.key, url);
									case 'ExternalGoto':
										var url = cmdMsg.a;
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										page: $author$project$Main$TutorialPage(newTmodel)
									}),
								cmd);
						} else {
							break _v0$4;
	...
	var $waratuman$elm_coder$Base16$scheme = { charToInt: $waratuman$elm_coder$Base16$charToInt, chars: 2, intToChar: $waratuman$elm_coder$Base16$intToChar, octets: 1, padChar: '=' };
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Border$shadow(
					{
						blur: 10,
						color: $author$project$Style$darkGrey,
						...
						_List_fromArray(
							[
								...
								A2(
									...
									{
										label: $mdgriffith$elm_ui$Element$text('James Barnes'),
								...
								A2(
									...
									{
										label: $mdgriffith$elm_ui$Element$text('Haskell.org'),
			...
			_List_fromArray(
				[
					A2(
						...
						_List_Nil,
						{ description: 'LMHTFY Logo', src: 'public/images/lmhtfy.svg' })
				])));
	var $author$project$Pages$Query$ClearLink = { $: 'ClearLink' };
	var $author$project$Pages$Query$CopyLink = function (a) {
		return { $: 'CopyLink', a: a };
	};
	var $author$project$Pages$Query$GenerateLink = { $: 'GenerateLink' };
	var $author$project$Pages$Query$QueryChanged = function (a) {
		return { $: 'QueryChanged', a: a };
	};
	var $author$project$Pages$Query$TryItOut = { $: 'TryItOut' };
					...
					[
						A2(
							...
							A2(
								...
								{
									label: $mdgriffith$elm_ui$Element$Input$labelHidden('Query'),
									onChange: $author$project$Pages$Query$QueryChanged,
							...
							A2(
								...
								_Utils_ap(
									$elm_community$maybe_extra$Maybe$Extra$toList(
										A2(
											...
											$elm$core$Basics$always(
												{
													label: $mdgriffith$elm_ui$Element$text('Copy Link'),
									...
									_List_fromArray(
										[
											{
												label: $mdgriffith$elm_ui$Element$text('Generate Link'),
												onPress: $elm$core$Maybe$Just(
													emptyQuery ? $author$project$Pages$Query$ClearLink : $author$project$Pages$Query$GenerateLink)
											},
											{
												label: $mdgriffith$elm_ui$Element$text('Try It Out'),
												onPress: emptyQuery ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just($author$project$Pages$Query$TryItOut)
											}
										]))))
					]),
				$elm_community$maybe_extra$Maybe$Extra$toList(
												...
												]),
											{
												label: $mdgriffith$elm_ui$Element$text(
													_Utils_ap(
														model.url,
														A2($elm$url$Url$Builder$relative, _List_Nil, params))),
												url: A2($elm$url$Url$Builder$absolute, _List_Nil, params)
											})
									]));
						},
						model.link))));
	};
	var $author$project$Pages$Tutorial$HoogleIt = { $: 'HoogleIt' };
	var $author$project$Pages$Tutorial$Query = { $: 'Query' };
											...
											_List_fromArray(
												[
													...
													A2(
														...
														{
															label: $mdgriffith$elm_ui$Element$text($author$project$Pages$Tutorial$hoogleDomain),
															url: $author$project$Pages$Tutorial$hoogleHome
														})
												])),
										$mdgriffith$elm_ui$Element$text('Search for: ' + model.query),
						...
						A2(
							...
							A2(
								...
								_List_fromArray(
									[
										{
											label: $mdgriffith$elm_ui$Element$text('Hoogle It'),
											onPress: $elm$core$Maybe$Just($author$project$Pages$Tutorial$HoogleIt)
										},
										{
											label: $mdgriffith$elm_ui$Element$text('Try Another'),
											onPress: $elm$core$Maybe$Just($author$project$Pages$Tutorial$Query)
										}
									])))
					])));
	};
